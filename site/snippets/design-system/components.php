...
<div class="space-y-8 max-w-5xl mt-12">
  ...
  <!-- Info Alert -->
  <div class="bg-white border border-ink/10 border-l-[6px] border-l-oceanic-dark p-8 flex items-start gap-8 shadow-none rounded-none">
  ...
  <!-- Success Alert -->
  <div class="bg-white border border-ink/10 border-l-[6px] border-l-slate-teal p-8 flex items-start gap-8 shadow-none rounded-none">
  ...
  <!-- Warning Alert -->
  <div class="bg-white border border-ink/10 border-l-[6px] border-l-warm-gold p-8 flex items-start gap-8 shadow-none rounded-none">
