...
old_container = """    <div class="relative w-full max-w-2xl mb-12">
        <div class="absolute top-1/2 -translate-y-1/2 left-5 pointer-events-none">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-ink/40"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
        </div>
        <input type="text" id="icon-search" placeholder="Search icons..." class="w-full w-full px-6 py-4 pl-14 text-lg border-2 border-ink/10 rounded-xl hover:border-ink/20 bg-canvas text-ink focus:outline-none focus:border-oceanic focus:ring-1 focus:ring-oceanic transition-colors">
    </div>"""

new_container = """    <div class="relative w-full max-w-2xl mb-12 flex items-center">
